...
if ($login->isUserLoggedIn() == true) {
	...
	include("login/views/logged_in.php");
		...
		{
			header( 'Location: /foreignfiction/index.php?s='.$req.'&f_lang=0&f_columns=0&f_ext=0', true, 301 );
		}
		...
		<td><input type='radio' name='lg_topic' value='scimag' " . $scimagchecked . "><a href='/scimag/index.php'>$LANG_MESS_19</a></td>
		...
		*/
		...
		// enable this if you want menu line 824
		...
		if ($mode == 'search')
		{
			...
			$args = "search.php?$openreq&req=$req_htm_enc&phrase=$full_phrase&view=$view";
		...
		{
			$args = "search.php?mode=$mode&view=$view&phrase=$full_phrase&timefirst=$timefirst&timelast=$timelast";
		}
		...
		if (!$mainpage)
		{
			echo "<table width=100% border=0><tr><td>$form</td><td><a href='/'><font color=#A00000 valign=top align=right><h1>Papyrus</a></td></tr></table>";
		}
