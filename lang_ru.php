...
$LANG_MESS_78 = 'Укажите прямую ссылку для загрузки (макс. 350 Мб, мин. 50кБ, если возможно без *.rar, *.zip)';
...
$libgennews = '
<a href="http://libgen.org/foreignfiction/librarian">Добавлена форма загрузки для художественной литературы (log:pass см. на форуме)</a><br>';
